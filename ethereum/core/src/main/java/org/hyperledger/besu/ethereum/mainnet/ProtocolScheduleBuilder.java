...
public class ProtocolScheduleBuilder extends AbstractProtocolScheduleBuilder {
  ...
  protected Stream<Optional<BuilderMapEntry>> createMilestones(
    ...
    return Stream.of(
        ...
        create(config.getFutureBlockNumber(), specFactory.futureDefinition(config)),
        create(config.getExperimentalBlockNumber(), specFactory.experimentalDefinition(config)),
        // Classic Milestones
