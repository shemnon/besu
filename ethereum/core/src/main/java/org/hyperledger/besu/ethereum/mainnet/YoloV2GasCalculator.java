...
public class YoloV2GasCalculator extends IstanbulGasCalculator {

  // new constants for YOLOv2
  ...
  protected YoloV2GasCalculator(final int maxPrecompile) {
    this.maxPrecompile = maxPrecompile;
  }

  public YoloV2GasCalculator() {
  ...
  public Gas extCodeCopyOperationGasCost(
    ...
    return copyWordsToMemoryGasCost(
        frame, Gas.ZERO, COPY_WORD_GAS_COST, offset, length);
  }
