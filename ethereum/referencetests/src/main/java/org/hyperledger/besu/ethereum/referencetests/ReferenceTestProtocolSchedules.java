...
public class ReferenceTestProtocolSchedules {
  ...
  public static ReferenceTestProtocolSchedules create() {
    ...
    builder.put("Future", createSchedule(new StubGenesisConfigOptions().futureBlock(0)));
    builder.put(
        "Experimental", createSchedule(new StubGenesisConfigOptions().experimentalBlock(0)));
